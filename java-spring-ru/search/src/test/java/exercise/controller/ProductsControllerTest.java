...
class ProductsControllerTest {
    ...
    @BeforeEach
    public void setUp() {
        Category category = Instancio.of(modelGenerator.getCategoryModel()).create();
    ...
    public void testIndexWithTitleContains() throws Exception {
        MvcResult result = mockMvc.perform(get("/products?titleCont=lamp"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void testIndexWithPrice() throws Exception {
        MvcResult result = mockMvc.perform(get("/products?priceGt=20&priceLt=50"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void testIndexWithRating() throws Exception {
        MvcResult result = mockMvc.perform(get("/products?ratingGt=4"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void testIndexWithCategory() throws Exception {
        MvcResult result = mockMvc.perform(get("/products?categoryId=1"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    public void testIndexComplexCondition() throws Exception {
        MockHttpServletRequestBuilder request = get("/products?priceGt=10&priceLt=80&CategoryId=1&ratingGt=3&titleCont=b");
    ...
    public void testShow() throws Exception {
        ...
        MockHttpServletRequestBuilder request = get("/products/{id}", testProduct.getId());
        MvcResult result = mockMvc.perform(request)
                .andExpect(status().isOk())
                .andReturn();
        String body = result.getResponse().getContentAsString();
    ...
    public void testCreate() throws Exception {
        ProductDTO dto = mapper.map(testProduct);
        ...
        Product product = productRepository.findByTitle(testProduct.getTitle()).get();
    ...
    public void testUpdate() throws Exception {
        ...
        MockHttpServletRequestBuilder request = put("/products/{id}", testProduct.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .content(om.writeValueAsString(dto));
        ...
        Product task = productRepository.findById(testProduct.getId()).get();
    ...
    public void testPartialUpdate() throws Exception {
        ...
        HashMap<String, Long> dto = new HashMap<String, Long>();
    ...
    public void testDestroy() throws Exception {
        productRepository.save(testProduct);
        MockHttpServletRequestBuilder request = delete("/products/{id}", testProduct.getId());
        mockMvc.perform(request)
